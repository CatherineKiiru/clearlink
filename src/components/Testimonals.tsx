...
function Testimonals() {
  return (
    <div className="bg-[#F9FAFB] w-full">
      <div className="md:py-24 md:gap-12 md:flex md:grid-col-2 max-w-[1440px] px-5 mx-auto justify-center">
        <div className="md:max-w-[40rem] mt-10 md:mt-0 space-y-4 md:space-y-12">
          <img
            className="pt-10 md:pt-0 items-center md:items justify-center mx-auto"
            src="/src/images/shopify.svg"
            alt="shopify-logo"
          />
          <img className='items-center justify-center mx-auto' src="/src/images/stars.svg" alt="rating stars" />
          <h1 className="text-center justify-center mx-auto text-text-blue font-medium md:text-[44px]">
        ...
        <div className="md:scale-110 md:ml-10 mt-10 md:mt-8">
